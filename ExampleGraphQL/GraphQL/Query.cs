...
namespace ExampleGraphQL.GraphQL
{
    public class Query
    {
        ...
        [UsePaging] // enable paging -> ITS VERY IMPORTAN THE ORDER OF THE ATTRIBUTES  FOR ENABLE PAGING, FILTERING AND SORTING | PAGING MUST BE FIRST AND ABOVE THE OTHERS AND ALWAS UNDER THE USEDBCONTEXT ATTRIBUTE
